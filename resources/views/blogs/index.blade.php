                ...
                <tr
                    ...
                    <td class="px-6 py-4">
                        <span class="line-clamp-1">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi, laborum soluta fuga earum,
                            vero
                            dolorum similique et enim modi consectetur nisi, blanditiis voluptatibus sapiente minima
                            suscipit! Ipsum id nemo fugit!
                        </span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="line-clamp-1">
                    ...
                    <td class="px-6 py-4">
                        {{-- <span
                            class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Published</span>
                        --}}
                        <span
                            class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Draft</span>
                    </td>
